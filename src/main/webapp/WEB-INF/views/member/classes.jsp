...
<style>
    /* Dark text colors for headings and main elements */
    .classes-grid .class-tile h3 {
        color: #111827 !important; /* Deep black for the class headers */
        font-weight: 700;
    }

    /* Change meta text details and font awesome icons to sleek dark gray/black tones */
    .ct-trainer, .ct-meta, .ct-meta div, .ct-meta i, .ct-trainer i {
        color: #374151 !important; /* Charcoal dark tone for readability */
    }

    /* Enrolled badge subtle visual adjustments */
    .enrolled-indicator {
...
<%@ include file="/WEB-INF/views/shared/memberFooter.jsp" %><%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ taglib prefix="c"   uri="jakarta.tags.core" %>
<%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
