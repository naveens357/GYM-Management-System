        ...
        <div class="about-grid">
            ...
            <div class="about-img-box">
               <img src="${pageContext.request.contextPath}/Images/gym.png"
                     ...
                     onerror="this.style.display='none';this.parentElement.style.background='#ddd';this.parentElement.innerHTML='<div style=\'display:flex;align-items:center;justify-content:center;height:100%;color:#999;font-size:3rem;\'><i class=\'fas fa-image\'></i></div>'"/>
            </div>
